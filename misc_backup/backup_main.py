...
def gather_args():
        ...
        required.add_argument('-d', '--result_destination_directory', required=True, type=str,
        ...
        optional.add_argument('-s', '--submit_job', required = False, type = bool, help = '''Flag
                                whether to submit calculation for processing through
